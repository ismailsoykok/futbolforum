...
try {
    ...
    $countSql = "SELECT COUNT(*) AS toplam FROM ingiltere";
    ...
    // Verileri al
    $sql = "SELECT * FROM ingiltere ORDER BY tarih DESC LIMIT $basla, $adet";
...
<body style="background-image: url('img/plbg.jpg');">
<nav class="navbar navbar-default navbar-fixed-top" style="background-color: #38003c; height: 60px; border-bottom: none;">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="index.php" style="color: white; font-size: 18px;">Ana Menü</a>
        </div>
        <div class="navbar-center">
            <img src="img/pl3.png" alt="Center Image" style="height: 50px;">
        </div>
        <div class="navbar-right">
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color: white; font-size: 18px; font: bold;">Ligler <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="almanya.php">Bundesliga</a></li>
                        <li><a href="fransa.php">Ligue 1</a></li>
                        <li><a href="italya.php">Serie A</a></li>
