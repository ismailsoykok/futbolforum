...
try {
    ...
    $countSql = "SELECT COUNT(*) AS toplam FROM almanya";
    ...
    // Verileri al
    $sql = "SELECT * FROM almanya ORDER BY tarih DESC LIMIT $basla, $adet";
...
<body style="background-color: #C4C4C4;">
    <nav class="navbar navbar-default navbar-fixed-top" style="background-color: #575757; height: 60px; border-bottom: none;">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="index.php" style="color: white; font-size: 18px;">Ana Menü</a>
        </div>
        <div class="navbar-center">
            <img src="img/bundesliga.png" alt="Center Image" style="height: 40px;">
        </div>
