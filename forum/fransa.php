...
try {
    ...
    $countSql = "SELECT COUNT(*) AS toplam FROM fransa";
    ...
    // Verileri al
    $sql = "SELECT * FROM fransa ORDER BY tarih DESC LIMIT $basla, $adet";
...
<body style="background-image: url('img/ligue1bg.jpg');">
    <nav class="navbar navbar-default navbar-fixed-top" style="background-color: #085EFF; height: 60px; border-bottom: none;">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="index.php" style="color: white; font-size: 18px;">Ana Menü</a>
        </div>
        <div class="navbar-center">
            <img src="img/ligue1.jpg" alt="Center Image" style="height: 50px;">
        </div>
