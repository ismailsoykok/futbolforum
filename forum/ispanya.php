...
try {
    ...
    $countSql = "SELECT COUNT(*) AS toplam FROM ispanya";
    ...
    // Verileri al
    $sql = "SELECT * FROM ispanya ORDER BY tarih DESC LIMIT $basla, $adet";
...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" style="background-color: #FF4B44; height: 60px; border-bottom: none;">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="index.php" style="color: white; font-size: 18px;">Ana Menü</a>
        </div>
        <div class="navbar-center">
            <img src="img/laliga.jpg" alt="Center Image" style="height: 50px;">
        </div>
