...
try {
    ...
    $countSql = "SELECT COUNT(*) AS toplam FROM hikaye";
    ...
    // Verileri al
    $sql = "SELECT * FROM hikaye ORDER BY tarih DESC LIMIT $basla, $adet";
...
<body style="background-image: url('');">
    ...
    <div class="container-fluid">
        ...
        <div class="navbar-center">
            <a href="leurope.php"><img src="img/leurop.png" alt="Center Image" style="height: 50px;"></a>
        </div>
            ...
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="italya.php">İtalya</a></li>
                    </ul>
                </li>
            </ul>
        </div>
        ...
        <div class="content">
            <?php foreach ($veriler as $satır) { ?>
                <div class="photo-container">
                    <hr>
                    <h1 style="font-size: 30px;"> <?php echo $satır["baslik"]; ?> </h1>
